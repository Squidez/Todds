...
Le but du jeu est de tirer des paires, puis des brelan, etc. de dés de la même couleur. Afin de réussir les joueur·euses peuvent choisir des bonus lorsqu'iels échouent un niveau.
...
Le jeu se joue entièrement à la souris. Les joueur·euses peuvent sélectionner les dés en cliquant dessus, puis les relancer en appuyant sur le bouton **Lance les Dés**. La fin de la manche est toujours déterminée par les joueur·euses.
...
**Note:** Le jeu utilise encore la version *v3001* de *Kaplay*. La nouvelle version *v4000* a été publié pendant le développement du jeu. Malheureusement elle entre en conflit avec *loquace* en faisant apparaître les cartouches de texte sous la zone du jeu.
